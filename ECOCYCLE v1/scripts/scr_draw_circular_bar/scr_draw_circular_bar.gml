/// @desc scr_draw_circular_bar(_x , _y, value, max, colour, radius, transparency, width)
function scr_draw_circular_bar(_x, _y, value, max, colour, radius, transparency, width) {
